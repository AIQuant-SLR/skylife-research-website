        ...
        <div className="mt-16 p-8 rounded-xl border border-slate-800 bg-slate-900/30 backdrop-blur">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { value: "12", label: "Clusters Identified", icon: <NetworkIcon className="w-4 h-4" /> },
              { value: "0.8s", label: "Analysis Time", icon: <ZapIcon className="w-4 h-4" /> },
              { value: "24/7", label: "Real-time Monitoring", icon: <ActivityIcon className="w-4 h-4" /> },
            ].map((stat, index) => (
