...
export default function D3NetworkGraph({
  ...
  useEffect(() => {
    ...
    // Color scale by cluster - brighter, more vibrant colors
    const colorScale = d3.scaleOrdinal<number, string>()
      .domain([0, 1, 2, 3, 4])
      .range(['#06b6d4', '#a78bfa', '#34d399', '#fbbf24', '#f472b6']);
    ...
    // Add circles to nodes (increased default size with glow effect)
    node.append('circle')
      .attr('r', d => d.size || 18)
      .attr('fill', '#ffffff')
      .attr('stroke', '#a78bfa')
