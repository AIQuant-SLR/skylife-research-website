...
export default function Services() {
  ...
  const features = [
    ...
    "Co-Integrated Pairs Arbitrage Reports",
    "Peripheral Stock Movement Alerts",
    "Real-time Network Analysis Dashboard",
    "API Access for Network Graph Data and Trading",
  ];
            ...
            <div className="relative glass-panel rounded-2xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <span className="text-slate-400">Active Risk Optimized Network Portfolios</span>
                  <span className="text-2xl font-bold text-cyan-400">8</span>
                </div>

                <div className="flex justify-between items-center">
                  <span className="text-slate-400">Nodes Analyzed Today</span>
            ...
            >
              ...
              <div className={`relative overflow-hidden rounded-2xl border ${
                ...
                <div className="relative">
                  ...
                  {plan.id === 'enterprise' ? (
                    <a
                      href="https://calendar.app.google/ehzJEiqPgpqZ79mcA"
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`block w-full py-3 rounded-lg font-bold transition-all text-center border border-slate-700 text-slate-300 hover:bg-slate-800`}
                    >
                      Contact Sales
                    </a>
                  ) : (
